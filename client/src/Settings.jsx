   ...
   const [pass,setPass] = React.useState({
    ...
    const handlePasswordSubmit = async (e)=>{
       ...
       if(!token){
            ...
            setLoading(true)
            setOpen(true)
            axios.post('https://ggz.onrender.com/changepassword',{...pass},{
				...
				<div class="profile-tab-nav border-right">
					<div class="p-4">
						<div class="img-circle text-center mb-3">
							<img src={userData.profilePhotoUrl!==""?`https://ggz.onrender.com/${userData.profilePhotoUrl}`:'/images/avatar.png'} alt="Image" class="shadow"/>
						</div>
