...
const CustomReminder = () => {
       ...
       if(formattedDate>reminderFormattedDate){
        ...
        if(updatedSelectedTime<updatedCurrentTime){
          ...
          if(selectedValue==='email'){
           ...
           axios.post('http://localhost:5000/customreminder',
           {
            company,
            email:user.email
            ,title
  ...
  <div class="wrapper">
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',marginBottom:'30px'}}>
     <h2 style={{textAlign:'center',marginBottom:'15px',fontFamily:'cursive'}}>Custom Reminder</h2>
...
{selectedValue==='email' && <ul class="items">
  ...
  <div class="col-md-12">
   ...
   <div class="col-6">
    ...
    <input type="text" class="form-control" id="company" placeholder='Company...' value={company} onChange={handleCompanyChange}/>
  </div>
  <div class="col-6">
    <label for="type" class="form-label">Type</label>
    <input type="text" class="form-control" id="type" placeholder='Type...' value={type} onChange={handleTypeChange}/>
  </div>
  <div class="col-12">
    <label for="title" class="form-label">Job Title</label>
    <input type="text" class="form-control" id="title" placeholder='Title...' value={title} onChange={handleJobTitleChange}/>
  </div>
