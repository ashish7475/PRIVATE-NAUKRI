...
const Aboutme = () => {
  ...
  const texts = [
    "Click Me",
    "Ashish Kumar",
    "Founder and CEO of Private Naukri",
    ...
    <div class="about_section layout_padding">
      ...
      <div className="socials">
        <a
          ...
          target="_blank"
          href="https://www.facebook.com/profile.php?id=100008709068075"
        >
          <ion-icon
            name="logo-facebook"
            style={{ color: "#FF0303" }}
        ...
        <a
          class="social-icon__link"
          target="_blank"
          href="https://twitter.com/ashishk7475"
        >
        ...
        <a
          class="social-icon__link"
          target="_blank"
          href="https://www.linkedin.com/in/ashish-kumar-19bb3611b/"
        >
          <ion-icon
            name="logo-linkedin"
            style={{ color: "#FF0303" }}
        ...
        <a
          class="social-icon__link"
          target="_blank"
          href="https://github.com/ashish7475"
        >
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="about_image">
                <img class="aboutme_image" src="images/ashish2.png" />
              </div>
            </div>
            <div class="col-lg-6">
