      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
           {userData && <img src={`http://localhost:5000/${userData.profilePhotoUrl}`}
        ...
        <div class="card mb-3" style={{borderRadius:'.5rem'}}>
          <div class="row g-0" >
            <div class="col-md-4 gradient-custom text-center text-white"
              ...
              <Button style={{borderRadius:'50%'}}  onClick={handleClickOpen}>
                       {userData && <img src={`http://localhost:5000/${userData.profilePhotoUrl}`}
                alt="Avatar" class="img-fluid my-5" style={{borderRadius:'50%'}} />}
              ...
              <div class="card-body p-4">
                ...
                <div class="row pt-1">
                  ...
                  <div class="col-6 mb-3">
                    <h6>Username</h6>
                    <p class="text-muted">{userData &&userData.username}</p>
                  </div>
                </div>
